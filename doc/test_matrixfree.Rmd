...
Here we are checking the sparse-matrix version of `pQF` on a really unsuitably small example with 67 markers, because it's the one that comes with the `SKAT` package: see `help(SKAT)`
